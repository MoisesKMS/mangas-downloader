...
listaSeries = contenedorSeries.findAll('div', 'col-6 col-sm-6 col-md-6 col-xl-3')


for serie in listaSeries:
    #Obtener Imagen Serie
    contenedorImagen = BeautifulSoup(str(serie.find('img', class_='series-image')), 'html.parser').img
