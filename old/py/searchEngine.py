...
if(soup.find('span', class_="page-numbers current")):
    currentPage = soup.find('span', class_="page-numbers current").text
    contentTotalPages = soup.find_all('a', class_= "page-numbers")
else:
    currentPage = "1"
    contentTotalPages.append('1')


print("Pagina " + str(currentPage) + " de " + str(len(contentTotalPages)))
